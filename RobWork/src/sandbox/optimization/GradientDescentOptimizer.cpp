...
namespace rwlibs { namespace optimization {
    ...
    GradientDescentOptimizer::GradientDescentOptimizer(typename FunctionType::Ptr function,
                                                       double alpha, double stepSizeLimit) :
        GradientOptimizer(function),
        _alpha(alpha), _stepSizeLimit(stepSizeLimit) {}
    ...
    void GradientDescentOptimizer::step(VectorType& currentGuess, ResultType& currentValue,
                                        double& currentError) {

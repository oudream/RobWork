...
namespace rwlibs { namespace optimization {
    ...
    class Optimizer
    {
      ...
      public:
        ...
        typename FunctionType::Ptr getFunction() const { return _function; }

        //! Set optimized function
        virtual void setFunction(typename FunctionType::Ptr function) { _function = function; }
         ...
         */
        VectorType optimize(VectorType initialGuess, const StopCondition& stopCondition);

        /**
         * @brief Get current result.
         */
        VectorType getCurrentGuess() const { return _currentGuess; }

        /**
         * @brief Get function value at the current result
         */
        ResultType getCurrentValue() const { return _currentValue; }

        //! Get number of steps taken.
        unsigned long getStepCount() const { return _stepCount; }

        //! Get current tolerance.
        double getCurrentError() const { return _currentError; }
         ...
         */
        void setLogging(bool enable) { _logging = enable; }

        /**
         * @brief Access optimization log.
         */
        const std::vector<State>& getLog() const { return _log; }

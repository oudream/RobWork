...
namespace rwlibs { namespace optimization {
    ...
    class OptimizerFactory
    {
      ...
      public:
         ...
         */
        virtual Optimizer::Ptr makeDirectOptimizer(typename FunctionType::Ptr function);
         ...
         */
        virtual Optimizer::Ptr makeGradientOptimizer(typename FunctionType::Ptr function);

...
namespace rwlibs { namespace optimization {
    ...
    class LineSearch : public Optimizer
    {
      ...
      public:
        ...
        const VectorType& getDirection() const { return _direction; }
        ...
        double getLeftBracket() const { return _leftBracket; }

        void setLeftBracket(double leftBracket) { _leftBracket = leftBracket; }

        double getRightBracket() const { return _rightBracket; }

        void setRightBracket(double rightBracket) { _rightBracket = rightBracket; }

        VectorType getStartPoint() const { return _startPoint; }

        void setStartPoint(VectorType startPoint) { _startPoint = startPoint; }

...
namespace rwlibs { namespace optimization {
    ...
    namespace {
        ...
        typedef typename rw::math::NumericalDerivative<ResultType, VectorType, GradientType>
            NumericalDerivativeType;

        //! Numerical derivative first differences  method type
        typedef typename rw::math::FirstDifferences<ResultType, VectorType, GradientType>
            FirstDifferencesMethod;
    }    // namespace
    ...
    class GradientOptimizer : public Optimizer
    {
      ...
      public:
         ...
         * @param numericalDerivative [in] a preferred method for wrapping functions with numerical
         * derivatives (default: uses first differences)
         */
         ...
         * If a function without derivative implementation is passed, it is automatically wrapped

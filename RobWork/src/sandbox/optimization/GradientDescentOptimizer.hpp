...
namespace rwlibs { namespace optimization {
    ...
    class GradientDescentOptimizer : public GradientOptimizer
    {
      ...
      public:
         ...
         * @param stepSizeLimit [in] the limit for the step size (default:
         * std::numeric_limits<double>::max())
         */
        GradientDescentOptimizer(typename FunctionType::Ptr function, double alpha = 1.0,
        ...
        double getStepSizeLimit() const { return _stepSizeLimit; }

        //! Set the limit for step size
        void setStepSizeLimit(double limit) { _stepSizeLimit = limit; }

...
namespace rwlibs { namespace optimization {
    ...
    PowellOptimizer::PowellOptimizer(typename FunctionType::Ptr function, double stepSize,
    ...
    void PowellOptimizer::newOptimization(const VectorType& initialGuess, ResultType& initialValue,
                                          double& initialError) {
        /*

...
namespace rw { namespace math {
    ...
    /**
     * Interface to adapt a function without derivative into function with numerically calculated
     * derivative
     */
    template<typename RES_T = double, typename ARG_T = double, typename GRAD_T = double>
    class FunctionWithNumericalDerivative : public rw::math::Function1Diff<RES_T, ARG_T, GRAD_T>
    {
      public:
        //! Smart pointer.
      ...
      public:
         ...
         */
        virtual RES_T f(ARG_T q) { return _function->f(q); }

        /**
         * @brief Returns numerically calculated function derivative
         */
        virtual GRAD_T df(ARG_T q) { return _derivative->derivative(_function, q); }

        //! Get wrapped function.
        typename Function<RES_T, ARG_T>::Ptr getFunction() { return _function; }

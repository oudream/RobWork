...
namespace rw { namespace math {
    ...
    class FunctionWrapper : virtual public Function<RES_T, ARG_T>
    {
      ...
      public:
         ...
         */
        FunctionWrapper(typename boost::function<RES_T(ARG_T)> f) : _f(f) {}
         ...
         */
        virtual RES_T f(ARG_T q) { return _f(q); }

        //! Get the wrapped callback.
        typename boost::function<RES_T(ARG_T)> getCallback() { return _f; }
                                 ...
                                 virtual public Function1Diff<RES_T, ARG_T, GRAD_T>
    {
      ...
      public:
         ...
         */
        virtual GRAD_T df(ARG_T q) { return _df(q); }

        //! Get the wrapped callback.
        typename boost::function<RES_T(ARG_T)> getGradientCallback() { return _df; }

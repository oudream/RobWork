...
namespace rwlibs { namespace algorithms {
    ...
    class BasicGPMM
    {
      public:
         ...
         */
        BasicGPMM(const rw::models::TreeDevice* device, const rw::kinematics::State& state,
         ...
         * given instead.
         * @param device [in] Device to work with
         * @param foi [in] The frames on the device to control. Usually this will be the tool, but
         * not necessarily.
         * @param state [in] Default state
         * @param qhome [in] Configuration somewhere between the lower and upper limit and towards
         * which the joints should move
        ...
        rw::math::Q solve(const rw::math::Q& q, const rw::math::Q& dq,
                          const std::vector<rw::math::VelocityScrew6D<>>& tcpvel);

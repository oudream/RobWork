...
namespace rw { namespace graspplanning {
    ...
    class SDHGraspPlanner2D
    {
      public:
         ...
         * configurations.
         */
        SDHGraspPlanner2D(const rw::models::TreeDevice& hand, rw::models::JointDevice& robot,
         ...
         */
        void setContour(const rw::geometry::Contour2D& contour,
         ...
         * contour in meters
         */
        void setApproachClearance(double clerance) { _clerance = clerance; }
         ...
         */
        void setMaxObjectHeight(double objHeight) { _maxObjHeight = objHeight; }

        /***
         * @brief set the height to grasp the object in.
         */
        void setGraspHeight(double graspHeight) { _graspHeight = graspHeight; }
         ...
         * @return
         */
        const std::vector<Grasp2D>& getGrasps() { return _grasps; }

        CG3Grasp2DGen& getGraspGenerator() { return _graspGen; }

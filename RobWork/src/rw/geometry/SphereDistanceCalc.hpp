...
namespace rw { namespace proximity {
    ...
    class SphereDistanceCalc
        : public rw::proximity::BVDistanceCalc< SphereDistanceCalc< T >, rw::geometry::BSphere< T > >
    {
      public:
         ...
         */
        inline T distance (const rw::geometry::BSphere< T >& a,
        ...
        inline T distance (const rw::geometry::BSphere< T >& a,
                                const rw::geometry::BSphere< T >& b)
        {
            return (a.getPosition()-b.getPosition()).norm2() - (a.getRadius () + b.getRadius ());
        }
...
#if defined(SWIG)
    #define BVDistanceCalcSphereDistanceCalc_TYPE(type) rw::proximity::BVDistanceCalc< rw::proximity::SphereDistanceCalc< type >, rw::geometry::BSphere< type > >

    SWIG_DECLARE_TEMPLATE (BVDistanceCalcSphereDistanceCalc, BVDistanceCalcSphereDistanceCalc_TYPE(double));
    SWIG_DECLARE_TEMPLATE (BVDistanceCalcSphereDistanceCalc_f, BVDistanceCalcSphereDistanceCalc_TYPE(float));

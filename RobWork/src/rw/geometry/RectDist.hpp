...
double distanceBetweenRectangles2(const Rotation& rotation, const Vector& position,
    ...
    double z =
        rotation(0, 2) * position(0) + rotation(1, 2) * position(1) + rotation(2, 2) * position(2);
...
double distanceBetweenRectangles3(const Rotation& R, const Vector& p, double r[2][2]) {
    ...
    if(R2dotP > r[0][0] * R(0, 1) + r[0][1] * R(1, 1) && R2dotP > r[0][1] * R(1, 1)) {
        ...
        if(p(1) > r[0][1] && p(1) + R(1, 0) * r[1][0] > r[0][1]) {
            ...
            else { t = R(0, 0) * s + r[0][1] * R(1, 0) - R1dotP; }
            ...
            v = Vector(p(0) + R(0, 0) * t - s, p(1) + R(1, 0) * t - r[0][1], p(2) + R(2, 0) * t);
    ...
    else if((p(0) + R(0, 0) * r[1][0] < 0 || p(0) + R(0, 1) * r[1][1] + R(0, 0) * r[1][0] < 0) &&
    ...
    if(R1dotP > R(0, 0) * r[0][0] && r[0][0] * R(0, 0) + r[0][1] * R(1, 0) < R1dotP) {
        ...
        if(p(0) > r[0][0] && p(0) + R(0, 1) * r[1][1] > r[0][0]) {
            ...
            else { t = R(1, 1) * s + R(0, 1) * r[0][0] - R2dotP; }
            ...
            v = Vector(p(0) + R(0, 1) * t - r[0][0], p(1) + R(1, 1) * t - s, p(2) + R(2, 1) * t);
    ...
    if((R1dotP > 0 || R1dotP > r[0][0] * R(0, 0)) && (p(1) < 0 || p(1) + R(1, 1) * r[1][1] < 0)) {
        den = 1 - R(0, 1) * R(0, 1);
    ...
    if(R2dotP > R(0, 1) * r[0][0] && R2dotP > R(0, 1) * r[0][0] + R(1, 1) * r[0][1]) {
        ...
        if(p(0) > r[0][0] && p(0) + R(0, 0) * r[1][0] > r[0][0]) {
            ...
            else { t = R(1, 0) * s + r[0][0] * R(0, 0) - R1dotP; }
            ...
            v = Vector(p(0) + R(0, 0) * t - r[0][0], p(1) + R(1, 0) * t - s, p(2) + R(2, 0) * t);
    ...
    if(R1dotP > r[0][1] * R(1, 0) && R1dotP > r[0][1] * R(1, 0) + r[0][0] * R(0, 0)) {
        ...
        if(p(1) > r[0][1] && p(1) + R(1, 1) * r[1][1] > r[0][1]) {
            ...
            else { t = R(0, 1) * s + r[0][1] * R(1, 1) - R2dotP; }
            ...
            v = Vector(p(0) + R(0, 1) * t - s, p(1) + R(1, 1) * t - r[0][1], p(2) + R(2, 1) * t);

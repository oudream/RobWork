    ...
    template<class T = size_t> class IndexedTriArray : public rw::geometry::TriMesh
    {
      ...
      public:
        ...
        IndexedTriArray(TriMesh::Ptr objArr) :
            ...
            _centerArr(
                rw::core::ownedPtr(new std::vector<rw::math::Vector3D<float>>(objArr->getSize()))),
            ...
            for(size_t i = 0; i < _idxArr->size(); i++) { (*_idxArr)[i] = (T) i; }
        ...
        IndexedTriArray(
            ...
            _objArr(objArr),
            _idxArr(idxArr), _centerArr(centerArr), _valArr(valArr), _valCenterArr(valCenterArr),

...
rw::common::iter_pair< PropertyMap::iterator > PropertyMap::getProperties () const
{
    return rw::common::iter_pair< PropertyMap::iterator >(std::make_pair (_properties.begin (), _properties.end ()));
}

...
namespace rw { namespace core {
      ...
      public:
        ...
        */
        ...
        /**
           ...
           The constructor is implicit on purpose.
        */
        Ptr (shared_ptr ptr) : _ptr (ptr.get ()), _owned_ptr (ptr) {}
        ...
        template< class S >
        Ptr< T > (Ptr< S > const& p,
                  typename boost::enable_if< boost::is_base_of< T, S > >::type* = 0)
        {
    ...
    */
    ...
    {
        return Ptr< T > (boost::shared_ptr< T > (ptr));
    }

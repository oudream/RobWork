...
namespace rw { namespace core {
    ...
    class PropertyType
    {
      public:
        ...
        //! @copydoc getType(const rw::core::PropertyMap&)
        static PropertyType
        getType(const std::vector<rw::core::Ptr<rw::core::PropertyValueBase>>& value) {
        ...
        //! @copydoc getType(const rw::core::PropertyMap&)
        static PropertyType
        getType(const rw::trajectory::Path<rw::math::Transform3D<double>>& value) {
            return PropertyType(Transform3DPath);
        }
        //! @copydoc getType(const rw::core::PropertyMap&)
        static PropertyType
        getType(const rw::core::Ptr<rw::trajectory::Path<rw::math::Transform3D<double>>>& value) {

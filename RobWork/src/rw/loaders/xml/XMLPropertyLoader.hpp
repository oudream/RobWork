...
public:
     ...
     */
	static rw::core::PropertyBase::Ptr readProperty(xercesc::DOMElement* element, bool checkHeader = true);
     ...
     */
    static rw::core::PropertyMap readProperties(xercesc::DOMElement* element, bool checkHeader = true);

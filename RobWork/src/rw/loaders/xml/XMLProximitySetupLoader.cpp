    ...
    if(XMLString::equals(XMLProximitySetupFormat::idProximitySetup(), element->getNodeName())) {
        ...
        if(element->hasAttributes()) {
            if(element->hasAttribute(XMLProximitySetupFormat::idIncludeAllAttribute())) {
                ...
                if(XMLStr(attr).str() == "true") { setup.setUseIncludeAll(true); }
                else if(XMLStr(attr).str() == "false") { setup.setUseIncludeAll(false); }
                else {
                ...
                const XMLCh* attr =
                    element->getAttribute(XMLProximitySetupFormat::idExcludeStaticAttributePairs());
                if(XMLStr(attr).str() == "true") { setup.setUseExcludeStaticPairs(true); }
                else if(XMLStr(attr).str() == "false") { setup.setUseExcludeStaticPairs(false); }
                else {
                    RW_THROW(
                        "Unknown value for "

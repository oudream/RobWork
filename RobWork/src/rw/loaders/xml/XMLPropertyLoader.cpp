...
xercesc::DOMElement* getChildElement(xercesc::DOMElement* element, bool throwOnEmpty) {
    ...
    if(throwOnEmpty) RW_THROW("No child element to node " + XMLStr(element->getNodeName()).str());
    return NULL;
}
...
PropertyValueBase::Ptr XMLPropertyLoader::readPropertyValue(xercesc::DOMElement* valueNode) {
    ...
    if(XMLString::equals(child->getNodeName(), XMLPropertyFormat::idPropertyMap()))
        return ownedPtr(
            new PropertyValue<PropertyMap>(XMLPropertyLoader::readProperties(child, true)));
    ...
    if(XMLString::equals(child->getNodeName(), XMLBasisTypes::idString()))
        return ownedPtr(new PropertyValue<std::string>(XMLBasisTypes::readString(child)));
    if(XMLString::equals(child->getNodeName(), XMLBasisTypes::idStringList()))
        return ownedPtr(
            new PropertyValue<std::vector<std::string>>(XMLBasisTypes::readStringList(child)));
    if(XMLString::equals(child->getNodeName(), XMLBasisTypes::idIntList()))
        return ownedPtr(new PropertyValue<std::vector<int>>(XMLBasisTypes::readIntList(child)));
    if(XMLString::equals(child->getNodeName(), XMLBasisTypes::idDoubleList()))
        return ownedPtr(
            new PropertyValue<std::vector<double>>(XMLBasisTypes::readDoubleList(child)));
    if(XMLString::equals(child->getNodeName(), XMLBasisTypes::idDouble()))
        return ownedPtr(new PropertyValue<double>(XMLBasisTypes::readDouble(child)));
    if(XMLString::equals(child->getNodeName(), XMLBasisTypes::idFloat()))
        return ownedPtr(new PropertyValue<float>(XMLBasisTypes::readFloat(child)));
    ...
    if(XMLString::equals(child->getNodeName(), XMLBasisTypes::idVector3D()))
        return ownedPtr(new PropertyValue<Vector3D<>>(XMLBasisTypes::readVector3D(child)));
    if(XMLString::equals(child->getNodeName(), XMLBasisTypes::idVector2D()))
        return ownedPtr(new PropertyValue<Vector2D<>>(XMLBasisTypes::readVector2D(child)));
    ...
    if(XMLString::equals(child->getNodeName(), XMLBasisTypes::idTransform3D()))
        return ownedPtr(new PropertyValue<Transform3D<>>(XMLBasisTypes::readTransform3D(child)));
    if(XMLString::equals(child->getNodeName(), XMLBasisTypes::idRotation3D()))
        return ownedPtr(new PropertyValue<Rotation3D<>>(XMLBasisTypes::readRotation3D(child)));
    ...
    if(XMLString::equals(child->getNodeName(), XMLBasisTypes::idQuaternion()))
        return ownedPtr(new PropertyValue<Quaternion<>>(XMLBasisTypes::readQuaternion(child)));
    if(XMLString::equals(child->getNodeName(), XMLBasisTypes::idRotation2D()))
        return ownedPtr(new PropertyValue<Rotation2D<>>(XMLBasisTypes::readRotation2D(child)));
    if(XMLString::equals(child->getNodeName(), XMLBasisTypes::idVelocityScrew6D()))
        return ownedPtr(
            new PropertyValue<VelocityScrew6D<>>(XMLBasisTypes::readVelocityScrew6D(child)));
...
//    RW_THROW("Unable to find type of property " + name);
    ...
    if(name == "") RW_THROW("Unable to find name of property");
    if(valueElement == NULL) RW_THROW("Unable to find value of property " + name);

    const PropertyValueBase::Ptr baseval = readPropertyValue(valueElement);
    if(baseval.isNull()) return nullptr;
...
PropertyMap XMLPropertyLoader::load(const std::string& filename,

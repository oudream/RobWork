    ...
    template<typename ScannerT> struct definition
    {
      public:
        ...
        definition(Transform3DParser const& self) {
            ...
            rpypos_transform_r =
                ((rpy_r[var(_rpy) = arg1] >>
                  pos_r[var(_pos) = arg1])[self.result_ =
                                               construct_<Transform3D<>>(var(_pos), var(_rpy))]) |
                ((pos_r[var(_pos) = arg1] >>
                  rpy_r[var(_rpy) = arg1])[self.result_ =
                                               construct_<Transform3D<>>(var(_pos), var(_rpy))])
            ...
            auto func_e = [&](double d) {
                _t3d_v.push_back(d);
                for(size_t i = 0; i < _t3d_v.size(); i++) { _t3d(i / 4, i % 4) = _t3d_v[i]; }
            };
            ...
            colmodel_r =    // eps_p[ var( _model ) = colmodel_r.result_ ] >> // used to initialize
                ...
                (XMLAttElem_p(
                    ...
                    !transform3d_p[var(_model._transform) = arg1] >>
                        ...
                        *(geometry_r[push_back_a(_model._geo)])))[var(_model._isDrawable) = false];
                ...
                (XMLAttElem_p(
                 ...
                 XMLAttElem_p(
                     ...
                     XMLAtt_p("radius", real_p[var(_geo._radius) = arg1]) >>
                         XMLAtt_p("z", real_p[var(_geo._z) = arg1][var(_geo._type) = ConeType]) >>
                         *XMLAtt_p("level", real_p[var(_geo._level) = arg1]),
                     eps_p) |
                 XMLAttElem_p(
                     "Cylinder",
                 ...
                 XMLAttElem_p(
                     ...
                     XMLAtt_p("radius", real_p[var(_geo._radius) = arg1]) >>
                         ...
                         XMLAtt_p("z", real_p[var(_geo._z) = arg1][var(_geo._type) = TubeType]) >>
                         *XMLAtt_p("level", real_p[var(_geo._level) = arg1]),
                     eps_p) |
                 XMLAttElem_p(
                     "Custom",
  ...
  public:
    template<typename ScannerT> struct definition
    {
      private:
        ...
        rule<ScannerT> device_r, serialdevice_r, paralleldevice_r, treedevice_r, joint_r, dhjoint_r,
            depend_r, devicebody_r, chainbody_r, serialchain_r, jointstate_r, mobiledevice_r,
            configuration_r, junction_r;
        ...
        definition(XMLDeviceParser const& self) : model_p(_scope), frame_p(_scope) {
            ...
            /*calibration_r =
               ...
               var(_calibration._pos) = arg1 ]
                            ...
                            */
            proxsetup_r = XMLAttElem_p(
                "ProximitySetup",
                XMLAtt_p(
                    "file",
                    attrstr_p[var(_psetup._filename) = arg1][var(_psetup._scope) = var(_scope)] >>
            ...
            serialdevice_r =
                ...
                XMLAttElem_p("SerialDevice",
                             XMLAtt_p("name",
                                      attrstr_p[var(_dev._name) = arg1]
                                               [var(_dev._type) = SerialType][EnterScope(_scope)]),
                             devicebody_r)[LeaveScope(_scope)];
                ...
                XMLAttElem_p(
                    ...
                    (XMLAtt_p("name", attrstr_p[var(_frame._name) = arg1]) >>
                     ...
                     ((XMLAtt_p("d",
                      ...
                      (XMLAtt_p(
                           "b",
                           real_p[var(_dhparam._dhtype) = Revolute][var(_frame._type) = "Revolute"]
                                 [var(_dhparam._hgptype) = "parallel"][var(_dhparam._b) = arg1]) >>
                       (XMLAtt_p("offset", real_p[var(_dhparam._offset) = arg1 * Deg2Rad])))
...
std::shared_ptr<DummyWorkcell> XMLRWParser::parseWorkcell(
    ...
    if(!info.hit) { RW_THROW("Parsing of workcell failed!!"); }

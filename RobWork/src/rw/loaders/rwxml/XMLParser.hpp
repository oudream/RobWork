...
namespace rw { namespace loaders {
                                  ...
                                  rw::loaders::XMLAttElemParser<ParsableAttrT, ParsableElemT>>
    {
      ...
      public:
        ...
        parse(ScannerT const& scan) const {
            ...
            tmphit = XMLErrorHandler::StartEndExpected(_elemname)(boost::spirit::classic::ch_p('>'))
                         .parse(scan);
            if(!tmphit) return scan.no_match();
            scan.concat_match(hit, tmphit);
    ...
    template<typename ParsableAttrT, typename ParsableElemT>
    XMLAttElemParser<ParsableAttrT, ParsableElemT> XMLAttElem_p(const std::string& elemname,

...
namespace rw { namespace graphics {
    ...
    class WorkCellScene
    {
      public:
         ...
         */
        rw::core::Ptr<rw::graphics::DrawableGeometryNode>
        addLines(const std::string& name, const std::vector<rw::geometry::Line>& lines,
                 rw::core::Ptr<rw::kinematics::Frame> frame, int dmask = DrawableNode::Physical);
         ...
         */
        rw::core::Ptr<rw::graphics::DrawableGeometryNode>
        addGeometry(const std::string& name, rw::core::Ptr<rw::geometry::Geometry> geom,
                    rw::core::Ptr<rw::kinematics::Frame> frame, int dmask = DrawableNode::Physical);
         ...
         * @return a list of drawables
         */
        std::vector<DrawableNode::Ptr>
        getDrawables(const rw::core::Ptr<rw::kinematics::Frame> f) const;
         ...
         * @return group node.
         */
        rw::graphics::GroupNode::Ptr
        getNode(const rw::core::Ptr<rw::kinematics::Frame> frame) const;

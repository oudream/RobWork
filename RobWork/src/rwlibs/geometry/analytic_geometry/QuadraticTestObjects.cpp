...
QuadraticBREP::Ptr QuadraticTestObjects::objectA() {
    ...
    QuadraticCurve l8b(
        Vector3D<>(4, 0, -2), 3.5 * Vector3D<>::y(), Vector3D<>::z(), QuadraticCurve::Line);
    QuadraticCurve l9(
        Vector3D<>(-4, -3.5, -2), 49. / 8 * Vector3D<>::z(), Vector3D<>::y(), QuadraticCurve::Line);
    QuadraticCurve l10(
        Vector3D<>(4, -3.5, -2), 49. / 8 * Vector3D<>::z(), Vector3D<>::y(), QuadraticCurve::Line);
    QuadraticCurve l11(
        Vector3D<>(-4, 3.5, -2), 49. / 8 * Vector3D<>::z(), Vector3D<>::y(), QuadraticCurve::Line);
...
QuadraticBREP::Ptr QuadraticTestObjects::objectB() {
    ...
    static const QuadraticSurface::Ptr s1 =
        QuadraticSurface::makeEllipticCylinder(3, 4)->transform(Transform3D<>(Vector3D<>(0, 0, 5)));
    ...
    QuadraticCurve c1_4(
        Vector3D<>(0, 0, -5.5), Vector3D<>::y() * 4, Vector3D<>::x() * 3, QuadraticCurve::Elliptic);
    QuadraticCurve c2_3(

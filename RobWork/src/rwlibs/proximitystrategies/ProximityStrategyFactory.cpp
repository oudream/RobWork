...
ProximityStrategyFactory::makeCollisionStrategy(const std::string& id) {
    if(id == RWStr) { return rw::core::ownedPtr<>(new ProximityStrategyRW()); }
#ifdef RW_HAVE_PQP
    if(id == PQPStr) { return rw::core::ownedPtr<>(new ProximityStrategyPQP()); }
#endif

#ifdef RW_HAVE_YAOBI
    if(id == YAOBIStr) { return rw::core::ownedPtr(new ProximityStrategyYaobi()); }
#endif

#ifdef RW_HAVE_BULLET
    if(id == BulletStr) { return rw::core::ownedPtr(new ProximityStrategyBullet()); }
#endif

#ifdef RW_HAVE_FCL
    if(id == FCLStr) { return rw::core::ownedPtr(new ProximityStrategyFCL()); }
#endif

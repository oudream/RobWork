...
MACRO(RWS_ADD_PLUGIN _name _component _lib_type)
  ...
  # ${MocSrcFiles} ${RccSrcFiles}) SET(CMAKE_LIBRARY_OUTPUT_DIRECTORY ${RWS_LIBRARY_OUT_DIR}) # Link the standard static
  # libraries with with the shared library: TARGET_LINK_LIBRARIES(${TargetName} ${ROBWORKSTUDIO_LIBRARIES})
  # INSTALL(TARGETS ${TargetName} DESTINATION ${BIN_INSTALL_DIR}) ENDIF () Set the VERSION and SOVERSION of the library
  # to the RobWorkStudio major and minor versions On MAC OS we can not do this if we are building a Module (where it

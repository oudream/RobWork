...
namespace rwhw { namespace camera {
    ...
    class DC1394Camera : public rw::sensor::CameraFirewire
    {
      public:
         ...
         */
        DC1394Camera (dc1394camera_t* dc1394cam);
         ...
         */
        virtual bool setFeature (CameraFirewire::CameraFeature setting,
         ...
         *
         **/
        bool getFormat7ImageSize (const CameraFirewire::Format7Mode mode, unsigned int& width,
                                  unsigned int& heigth);
         ...
         **/
        bool getFormat7ImageMaxSize (const CameraFirewire::Format7Mode mode, unsigned int& width,
                                     unsigned int& heigth);
         ...
         * @return true if the packet size could be received from the camera
         **/
        bool getFormat7RecommendedPacketSize (const CameraFirewire::Format7Mode mode,

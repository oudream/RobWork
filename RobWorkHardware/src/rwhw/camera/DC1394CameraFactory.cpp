...
namespace rwhw { namespace camera {
    ...
    DC1394CameraFactory* DC1394CameraFactory::_instance =
        0;    // definition outside class declaration
    ...
    const std::vector< std::string >& DC1394CameraFactory::getCameraList () { return _cameraNames; }

...
class Trakstar
{
  ...
  private:
    ...
    std::vector< TRANSMITTER_CONFIGURATION >
        _pXmtr;    // a pointer to an array of transmitter objects
    ...
    int _sensorsAttached;    // Is updated with the actual number of connected sensors at
                             // startPolling()

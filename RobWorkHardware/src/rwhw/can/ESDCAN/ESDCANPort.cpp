...
bool openDevice (unsigned int netId, long txQueueSize, long rxQueueSize, NTCAN_HANDLE& handle)
{
    ...
    long ret = canOpen (netId, mode, txQueueSize, rxQueueSize, txtimeout, rxtimeout, &handle);
...
ESDCANPort::ESDCANPort (unsigned int netId, long txQueueSize, long rxQueueSize, CanBaud canBaud,
    ...
    _transmitDelay (transmitDelay), _portOpen (false), _handle (NULL)
{}
...
ESDCANPort* ESDCANPort::getPortInstance (unsigned int netId, long txQueueSize, long rxQueueSize,
                                         CanBaud canBaud,
                                         int transmitDelay)    // TODO: add baud ad can id type
{
    CanDeviceStatus status;

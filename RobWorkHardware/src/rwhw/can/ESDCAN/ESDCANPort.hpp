...
class ESDCANPort : public CanPort
{
  ...
  public:
     ...
     */
    static ESDCANPort* getPortInstance (unsigned int netId, long txQueueSize = 1,
                                        long rxQueueSize = 1, CanBaud canBaud = CanBaud250,
                                        int transmitDelay = 0);    // TODO: add baud ad can id type

...
IEICANPort::IEICANPort (unsigned int cardIdx, unsigned int portNr) :
    _cardIdx (cardIdx), _portNr (portNr), _portOpen (false)
{}
...
IEICANPort*
IEICANPort::getIEICANPortInstance (unsigned int cardIdx,
...
bool IEICANPort::write (unsigned int id, const std::vector< unsigned char >& raw_data)
{

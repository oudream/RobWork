 ...
 */
void ACI00::header (uword slave_no, uword memtype, uword memofs, uword memseg, char rorw,
 ...
 * the slave.
 */
void ACI00::send_header (uword slave, uword memtype, uword memofs, uword memseg, char rw,
                         uword data_length)
{
    char response;
 ...
 */
void ACI00::aci_xfr1 (uword slave_dev, uword memtype, uword memofs, uword memseg, char accesstype,
 ...
 * sequence.
 */
void ACI00::aci_xfr (uword slave_dev, uword memtype, uword memofs, uword memseg, char accesstype,
                     uword bytes, ubyte* memptr)
{
    inz_aci ();
...
bool ACI::GetLocation (const char* loc, float& x, float& y, float& z, float& roll, float& pitch,
                       float& yaw)
{
    char buf[100];

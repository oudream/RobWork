...
class URPrimaryInterface
{
  public:
     ...
     *
     * The method blocks until the thread has been stopped. Throws exception if unable to stop
     * thread within a given timeout
     */
    void stop ();
     ...
     */
    std::queue< URMessage > getMessages () { return _messages; }
  ...
  private:
    ...
    static const unsigned char ROBOT_MODE_DATA = 0, JOINT_DATA = 1, TOOL_DATA = 2,
                               MASTERBOARD_DATA = 3, CARTESIAN_INFO = 4, LASER_POINTER_POSITION = 5;

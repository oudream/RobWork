...
SDHDriver::SDHDriver () : _moveCmdTimeout (1.0)
{
...
bool SDHDriver::connect (const std::string& device, int canBaudRate, double canTimeOut, int id_read,
                         int id_write)
{
    try {
...
bool SDHDriver::connect (int canNetId, int canBaudRate, double canTimeOut, int id_read,
                         int id_write)
{
    try {
...
// const std::string statesStr[] = {"eAS_IDLE", "eAS_POSITIONING", "eAS_IDLE", "eAS_IDLE",
// "eAS_IDLE", "eAS_DISABLED", "eAS_IDLE"};

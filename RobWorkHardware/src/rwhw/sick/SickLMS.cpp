...
const uchar LMS_SETUP1[]     = {0x02, 0x00, 0x05, 0x00, 0x3b, 0x64, 0x00, 0x64, 0x00};
const uchar LMS_SETUP1_ACK[] = {
    0x06, 0x02, 0x80, 0x07, 0x00, 0xbb, 0x01, 0x64, 0x00, 0x64, 0x00, 0x10};

// Set to 100deg angular range and 0.5deg resolution
const uchar LMS_SETUP2[]     = {0x02, 0x00, 0x05, 0x00, 0x3b, 0x64, 0x00, 0x32, 0x00};
const uchar LMS_SETUP2_ACK[] = {
    0x06, 0x02, 0x80, 0x07, 0x00, 0xbb, 0x01, 0x64, 0x00, 0x32, 0x00, 0x10};

// Set to 100deg angular range and 0.25deg resolution
const uchar LMS_SETUP3[]     = {0x02, 0x00, 0x05, 0x00, 0x3b, 0x64, 0x00, 0x19, 0x00};
const uchar LMS_SETUP3_ACK[] = {
    0x06, 0x02, 0x80, 0x07, 0x00, 0xbb, 0x01, 0x64, 0x00, 0x19, 0x00, 0x10};

// Set to 180deg angular range and 1deg resolution
const uchar LMS_SETUP4[]     = {0x02, 0x00, 0x05, 0x00, 0x3b, 0xb4, 0x00, 0x64, 0x00};
const uchar LMS_SETUP4_ACK[] = {
    0x06, 0x02, 0x80, 0x07, 0x00, 0xbb, 0x01, 0xb4, 0x00, 0x64, 0x00, 0x10};

// Set to 180deg angular range and 0.5deg resolution
const uchar LMS_SETUP5[]     = {0x02, 0x00, 0x05, 0x00, 0x3b, 0xb4, 0x00, 0x32, 0x00};
const uchar LMS_SETUP5_ACK[] = {
    0x06, 0x02, 0x80, 0x07, 0x00, 0xbb, 0x01, 0xb4, 0x00, 0x32, 0x00, 0x10};

// Packages to set up the modes
const uchar LMS_PASSWORD[] = {
    0x02, 0x00, 0x0a, 0x00, 0x20, 0x00, 0x53, 0x49, 0x43, 0x4b, 0x5f, 0x4c, 0x4d, 0x53};

const uchar LMS_SETUP_UNIT_MM[] = {0x02, 0x00, 0x23, 0x00, 0x77, 0x00, 0x00, 0x46, 0x00, 0x01,
                                   0x00, 0x01, 0x00, 0x00, 0x02, 0x02, 0x02, 0x00, 0x00, 0x0a,
                                   0x0a, 0x50, 0x64, 0x00, 0x0a, 0x0a, 0x50, 0x80, 0x00, 0x0a,
                                   0x0a, 0x50, 0x64, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00};

const uchar LMS_SETUP_UNIT_CM[] = {0x02, 0x00, 0x23, 0x00, 0x77, 0x00, 0x00, 0x46, 0x00, 0x01,
                                   0x00, 0x00, 0x00, 0x00, 0x02, 0x02, 0x02, 0x00, 0x00, 0x0a,
                                   0x0a, 0x50, 0x64, 0x00, 0x0a, 0x0a, 0x50, 0x80, 0x00, 0x0a,
                                   0x0a, 0x50, 0x64, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00};

const uchar LMS_SETUP_UNIT_MM_ACK[] = {
    0x06, 0x02, 0x80, 0x25, 0x00, 0xf7, 0x01, 0x00, 0x00, 0x46, 0x00, 0x01, 0x00, 0x01,
...
const uchar LMS_SETUP_UNIT_CM_ACK[] = {
    0x06, 0x02, 0x80, 0x25, 0x00, 0xf7, 0x01, 0x00, 0x00, 0x46, 0x00, 0x01, 0x00, 0x00,
    0x00, 0x00, 0x02, 0x02, 0x02, 0x00, 0x00, 0x0a, 0x0a, 0x50, 0x64, 0x00, 0x0a, 0x0a,
    0x50, 0x80, 0x00, 0x0a, 0x0a, 0x50, 0x64, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x10};
...
// Ack for commands
const uchar LMS_CMD_ACK[] = {0x06, 0x02, 0x80, 0x03, 0x00, 0xa0, 0x00, 0x10};
...
// bool SickLMS::connectToLMS(int range_mode, int angResMode, int unitMode, char * port, int
// baud_sel)

bool SickLMS::connectToLMS (AngRange angRange, AngResolution angResolution, Units units,
...
float SickLMS::getAngle (int i)
{
    switch (_angResolution) {
        case AngRes1Deg: return i - 90.0f;
        case AngRes05Deg: return i / 2.0f - 90.0f;
        case AngRes025Deg: return i / 4.0f - 90.0f;
    }
    return 0;
}

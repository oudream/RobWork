...
class SerialPort
{
  ...
  public:
     ...
     */
    virtual bool open (const std::string& port, Baudrate baudrate, DataBits dbits = Data8,
                       Parity parity = None, StopBits stopbits = Stop1_0);
     ...
     */
    virtual bool read (char* buf, const unsigned int n, const unsigned int timeout,

...
std::vector< unsigned char > PCubeProtocol::makeData (int commandId, int motionId, int val)
{
...
std::vector< unsigned char > PCubeProtocol::makeData (int commandId, int motionId, float val)
{
    ToData move_data (val);
    std::vector< unsigned char > data;
    data.push_back (commandId);
...
std::vector< unsigned char > PCubeProtocol::makeData (int commandId, int motionId, float x, int y)
{
    std::vector< unsigned char > data;
    data.push_back (commandId);
    data.push_back (motionId);
...
std::vector< unsigned char > PCubeProtocol::makeData (int commandId, int motionId, int x, int y)
{
    std::vector< unsigned char > data;
    data.push_back (commandId);
    data.push_back (motionId);
...
// B�gild
std::vector< unsigned char > PCubeProtocol::makeData (int commandId, int parameterId,
                                                      unsigned int val)
{
    ToData move_data (val);
    std::vector< unsigned char > data;

...
void DockWelder::printStatus (std::ostream& ostr)
{
    ...
    ostr << "VGT Status: "
         ...
         << "frezed: " << s.fj00 << " " << s.fj01 << " " << s.fj02 << " " << s.fj10 << " " << s.fj11
         << " " << s.fj12 << "\n"

         << "Lower Limits: " << s.lj00 << "\t" << s.lj01 << "\t" << s.lj02 << "\t" << s.lj10 << "\t"
         << s.lj11 << "\t" << s.lj12 << "\n"

         << "Upper Limits: " << s.hj00 << "\t" << s.hj01 << "\t" << s.hj02 << "\t" << s.hj10 << "\t"
         << s.hj11 << "\t" << s.hj12
...
DockWelder::Status DockWelder::status ()
{
    ...
    if (sscanf (buf,
                ...
                &dummy,
                &dummy,
                &dummy,    // position for old kinematic
                &dummy,
                &dummy,
                &(dummy),    // rotation for old kinematic
                &(s.lj00),
                &(s.hj00),
                &(s.lj01),
                &(s.hj01),

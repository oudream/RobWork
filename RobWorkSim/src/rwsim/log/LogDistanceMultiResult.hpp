...
namespace rwsim { namespace log {
    ...
    class LogDistanceMultiResult : public SimulatorLogEntry
    {
      public:
        ...
        typedef rw::core::Ptr<LogDistanceMultiResult> Ptr;

        //! Smart pointer type of const LogDistanceMultiResult
        typedef rw::core::Ptr<const LogDistanceMultiResult> CPtr;
         ...
         */
        void addResults(const std::vector<rw::proximity::DistanceMultiStrategy::Result>& results);

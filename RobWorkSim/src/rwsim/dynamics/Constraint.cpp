...
bool Constraint::toConstraintType(const std::string& string, ConstraintType& type) {
    ...
    if(typeUpper == "FIXED") type = Constraint::Fixed;
    else if(typeUpper == "PRISMATIC") type = Constraint::Prismatic;
    else if(typeUpper == "REVOLUTE") type = Constraint::Revolute;
    else if(typeUpper == "UNIVERSAL") type = Constraint::Universal;
    else if(typeUpper == "SPHERICAL") type = Constraint::Spherical;
    else if(typeUpper == "PISTON") type = Constraint::Piston;
    else if(typeUpper == "PRISMATICROTOID") type = Constraint::PrismaticRotoid;
    else if(typeUpper == "PRISMATICUNIVERSAL") type = Constraint::PrismaticUniversal;
    else if(typeUpper == "FREE") type = Constraint::Free;
    else return false;
    return true;
}

...
void TaskDialog::guiEvent() {
    ...
    else if(obj == ui.applyButton) { updateTaskDescription(); }
}
...
void TaskDialog::updateGUI() {
    ...
    ui.targetCombo->setCurrentIndex(
        ui.targetCombo->findText(QString::fromStdString(_td->getTargetObject()->getName())));
    ...
    ui.gripperCombo->setCurrentIndex(
        ui.gripperCombo->findText(QString::fromStdString(_td->getGripperDevice()->getName())));

...
int main(int argc, char* argv[]) {
    ...
    desc.add_options()("help,h", "help message")("length,l", value<double>(), "length of gripper")(
        "width,w", value<double>(), "width of gripper")(
        "depth,d", value<double>(), "depth of gripper")(
        "adepth,c", value<double>(), "depth of chamfer")(
        "aangle,x", value<double>(), "angle of chamfer")("cpos,p", value<double>(), "cut position")(
        "cdepth,v", value<double>(), "cut depth")("cangle,a", value<double>(), "cut angle");

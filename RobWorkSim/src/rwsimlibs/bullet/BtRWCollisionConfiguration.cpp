...
BtRWCollisionConfiguration::getCollisionAlgorithmCreateFunc(int proxyType0, int proxyType1) {
    ...
    if(btBroadphaseProxy::isCompound(proxyType0)) { return m_compoundCreateFunc; }
    else if(btBroadphaseProxy::isCompound(proxyType1)) { return m_swappedCompoundCreateFunc; }

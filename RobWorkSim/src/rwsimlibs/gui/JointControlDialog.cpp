...
VelTab::VelTab(rwlibs::control::JointController::Ptr jcontroller, QWidget* parent) :
    QWidget(parent) {
    if(!(jcontroller->getControlModes() & JointController::VELOCITY)) this->setDisabled(true);
}
...
JointControlDialog::JointControlDialog(rwsim::dynamics::DynamicDevice::Ptr device,
                                       QWidget* parent) {

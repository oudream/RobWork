...
/* TODO(TNT) this test don't work as it returns C++ exception with description
"Id[-1]ODESimulator.cpp:680 : Too Large Penetrations!" thrown in the test body. TEST (ODESimpleTest,
MultiOnTrayObjectStabilityTest)
{
    // add loading tests here
    DynamicWorkCell::Ptr dwc = DynamicWorkCellLoader::load (
